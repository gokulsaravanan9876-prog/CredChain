...
def _register_institution(client, email="lookup-inst@test.credchain.dev", name="Lookup University"):
...
def test_lookup_cannot_reach_another_institutions_student(client, db_session):
    ...
    inst_a = _register_institution(client, email="lookup-inst-a@test.credchain.dev", name="Lookup University A")
    inst_b = _register_institution(client, email="lookup-inst-b@test.credchain.dev", name="Lookup University B")
